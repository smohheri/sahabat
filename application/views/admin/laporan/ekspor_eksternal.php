<!-- Laporan Ekspor Eksternal - Redesain Modern -->
<div class="laporan-page">
	...
	<div class="page-header">
		<div class="header-info">
			...
			<div>
				<h2>Ekspor Eksternal</h2>
				<p>Data anak untuk keperluan eksternal panti, berisi informasi dasar anak</p>
			</div>
		</div>
		<div class="header-actions">
			<a href="<?php echo site_url('admin/export_pdf_eksternal'); ?>" class="btn btn-export-pdf" target="_blank">
				<i class="fas fa-file-pdf"></i> Export PDF
			</a>
			<a href="<?php echo site_url('admin/export_excel_eksternal'); ?>" class="btn btn-export-excel">
	...
	<div class="data-panel">
		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="data-table" id="tableEksporEksternal">
					<thead>
						<tr>
							<th>No</th>
							<th>Nama Anak</th>
					...
					<tbody>
						...
						foreach ($anak as $a): ?>
							<tr>
								...
								<td><?php echo umur($a->tanggal_lahir); ?> tahun</td>
								<td>
								...
								<td>
									<?php echo $a->pendidikan; ?>
								</td>
								<td>
									<?php echo $a->nama_sekolah ?: '-'; ?>
								</td>
								<td>
									<?php echo $a->status_tinggal ?: '-'; ?>
								</td>
								<td>
									<?php echo $a->kategori ?: '-'; ?>
								</td>
...
<style>
	...
	/* Dark Mode Styles for laporan/ekspor_eksternal.php */
